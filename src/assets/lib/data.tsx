...
export const headerIntroData = {
  ...
  description: {
    ...
    en: "I'm Abdul Rafay, a fullstack developer with the goal of advancing my career and participating in inspiring projects. Here I present my work and my passion for web development. Let's shape digital solutions together and shape the future!",
  },
  buttons: [
    {
      name: "Contact",
...
export const sideBarRightMail = {
  link: "mailto:abdulrafaywrites@gmail.com",
  text: "abdulrafaywrites@gmail.com",
} as const;

export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/abdul-rafay",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
    link: "https://github.com/SyedAbdulRafay",
    icon: FiGithub,
    altimgname: "github",
  },
  {
